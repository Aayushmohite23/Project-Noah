...
function IndiLike() {
  return (
    ...
    <div className='w-full flex flex-col justify-center items-center bg-custom-gradient-bpb-v opacity-70  p-10 lg:p-20'>
            ...
            <h2 className='font-semibold text-xl sm:text-3xl text-center mt-5'>Unlocking the Secrets of how It Shapes Our Minds and Souls<br/>
            ...
            <p className='font-normal text-xs sm:text-sm'>Published : November 2024</p>
      </div>
    </section>
  )
}
